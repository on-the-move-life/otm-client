...
function Overview({ weightInfoData }) {
    ...
    return (
        <div className="w-[100%] max-w-[326px] h-[457px] rounded-[22.291px] object-cover"
            style={{
        ...
        >
            <div className='w-full h-full px-4 pb-3 rounded-[22.291px] flex flex-col justify-between items-start relative' style={{
