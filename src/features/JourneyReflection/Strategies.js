...
const Strategies = () => {
  ...
  return (
    <div>
      <div className="mt-8 flex w-full flex-col items-start justify-center sm:mt-10">
        <h1
          className="purple-gradient w-full px-4 text-left text-[22.33px] sm:text-center sm:text-3xl"
