...
const FuturePlan = () => {
  ...
  return (
    <div>
        ...
        <h1 className='text-[#7E87EF] sm:text-4xl text-2xl sm:text-center text-left font-serif'>Future Plan</h1>
      </div>
      ...
      {futurePlan.map((prod,index)=>{
          return (
            ...
            <h2 className='text-white sm:text-lg text-sm text-center'>{prod.month}</h2>
            <h2 className='text-[#7E87EF] sm:text-lg text-sm text-center'>{prod.theme}</h2>
            </div>
