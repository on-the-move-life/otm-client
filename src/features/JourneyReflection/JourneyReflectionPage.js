...
const JourneyReflectionPage = () => {
  ...
  return (
    <div className='bg-[#1C1C1E] w-full h-auto flex flex-col'>
     ...
     <div className={`sm:px-10 px-4`}>
      ...
      <div className="sm:px-10 px-4 mt-10">
       <h1 className="sm:text-center text-left sm:text-3xl text-xl font-serif">Let's glance at your journey, <span className="text-[#7E87EF]">{firstName}!</span></h1>
      </div>
