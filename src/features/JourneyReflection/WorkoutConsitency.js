...
const WorkoutConsitency = () => {
  return (
    <div>
      ...
      <div className='flex flex-row overflow-x-auto sm:max-w-screen-lg max-w-screen-[400px] mx-auto overflow-hidden px-2 sm:mt-14 mt-10 hide-scrollbar'>
        <WorkoutGraph/>
      </div>
      <div className='sm:px-10 mt-8'>
        <p className='sm:text-base text-sm sm:text-center text-left sm:px-32 px-4 font-sf-pro'>{info.renewalReport.workoutConsistencySummary}</p>
      </div>
    </div>
  )
}
