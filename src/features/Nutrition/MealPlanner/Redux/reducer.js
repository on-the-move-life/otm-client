...
const reducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case Actions.DELETE_SELECTED_INGREDIENT:
      ...
      const updatedSelectedIngredients = state.selectedIngredients.filter(
        ...
        return {
          ...
          questionSectionInfo: {
            screen: action.payload.screen
              ...
              : state.questionSectionInfo.screen,
            currentScreenQuestions: action.payload.currentScreenQuestions
              ? action.payload.currentScreenQuestions
              : state.questionSectionInfo.currentScreenQuestions,
            totalScreens: action.payload.totalScreens
              ? action.payload.totalScreens
              : state.questionSectionInfo.totalScreens,
          },
        };
      }
