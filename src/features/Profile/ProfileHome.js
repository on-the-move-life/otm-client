...
const ProfileHome = () => {
  return (
    <div>
      <div class="text-neutral-400 ml-4 mt-4 text-[32px] font-medium leading-10">
        Profile
      </div>
      <div className="flex flex-col items-center justify-center">
        <div className="mt-6 flex flex-col items-center justify-center">
          ...
          <div className="flex w-40 flex-row items-center justify-between">
            ...
            <div class="inline-flex h-[18px] w-[41px] items-center justify-center rounded bg-indigo-400 px-2 py-0.5">
        ...
        <div className="mx-auto mt-8 h-[262px] w-[358px] rounded-xl border border-white bg-[#5F5F5F] bg-opacity-30 p-4 backdrop-blur-[75px]">
          ...
          <div className="bg-neutral-700 border-neutral-600 inline-flex h-[18px] items-center justify-center gap-0.5 rounded border bg-opacity-5 px-2 py-0.5 backdrop-blur-[34px]">
            <div className="text-neutral-400 text-xs capitalize">
              ₹5,000 renewed monthly
            </div>
          </div>
          <div className="bg-neutral-700 border-green-400 inline-flex h-[18px] items-center justify-center gap-0.5 rounded border bg-opacity-5 px-2 py-0.5 backdrop-blur-[34px]">
            <div className="text-xs capitalize text-green">
              Next payment due on 31 Jan 2024
            </div>
          </div>
          <div className="mt-6 flex flex-col items-center">
            <div className="my-2 inline-flex h-[41px] w-[334px] items-center justify-center rounded-lg bg-white bg-opacity-40 mix-blend-screen">
              <div className="text-neutral-400 text-lg font-medium">
                Make Payment
              </div>
            </div>
            <div className="bg-neutral-700 border-zinc-400 inline-flex h-[41px] w-[334px] items-center justify-center gap-2.5 rounded-lg border bg-opacity-5 p-2.5 backdrop-blur-xl">
              <div className="text-neutral-400 text-lg font-medium">
