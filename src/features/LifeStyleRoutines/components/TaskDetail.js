                ...
                <div className="mb-6">
                    ...
                    <div className="flex space-x-4 items-center justify-center w-full">
                        <button
                            ...
                            className={`transition-transform duration-200 ${selectedFeeling === 1 ? 'transform scale-125 bg-white/10 rounded-md' : ''
                                }`}
                        >
                            <img src={'./assets/Feeling-sad.svg'} alt="Sad" className={`w-15 h-15 ${selectedFeeling === 1 ? 'text-red-500' : ''}`} />
                        </button>
                        <button
                            onClick={() => setSelectedFeeling(2)}
                            className={`transition-transform duration-200 ${selectedFeeling === 2 ? 'transform scale-125  bg-white/10 rounded-md' : ''
                                }`}
                        >
                            <img src={'./assets/Feeling-sad2.svg'} alt="Neutral" className={`w-15 h-15 ${selectedFeeling === 2 ? 'text-yellow-500' : ''}`} />
                        </button>
                        <button
                            onClick={() => setSelectedFeeling(3)}
                            className={`transition-transform duration-200 ${selectedFeeling === 3 ? 'transform scale-125  bg-white/10 rounded-md' : ''
                                }`}
                        >
                            <img src={'./assets/Feeling-neutral.svg'} alt="Happy" className={`w-15 h-15 ${selectedFeeling === 3 ? 'text-yellow-400' : ''}`} />
                        </button>
                        <button
                            onClick={() => setSelectedFeeling(4)}
                            className={`transition-transform duration-200 ${selectedFeeling === 4 ? 'transform scale-125  bg-white/10 rounded-md' : ''
                                }`}
                        >
                            <img src={'./assets/Feeling-happy.svg'} alt="Very Happy" className={`w-15 h-15 ${selectedFeeling === 4 ? 'text-green-500' : ''}`} />
                        </button>
                        <button
                            onClick={() => setSelectedFeeling(5)}
                            className={`transition-transform duration-200 ${selectedFeeling === 5 ? 'transform scale-125  bg-white/10 rounded-md' : ''
                                }`}
                        >
                            <img src={'./assets/Feeling-happy.svg'} alt="Ecstatic" className={`w-15 h-15 ${selectedFeeling === 5 ? 'text-green-400' : ''}`} />
                        </button>
                    </div>
                </div>
