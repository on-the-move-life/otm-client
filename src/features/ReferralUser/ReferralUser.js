...
const ReferralUser = () => {
  ...
  return (
    <>
      {myParam ? (
        <div className="h-vh relative flex w-full flex-col items-center px-5 pb-10">
          <img
          ...
          <div className="relative z-[10] mr-2   flex  flex-col items-center  gap-[2px] rounded-xl   px-1 pb-1">
            <div className="flex max-w-[350px]  justify-end">
              ...
              >
                For the lack of a better word, OTM was life changing for me. It
                gave me the motivation I didn't believe I could achieve. I have
                literally changed my lifestyle upside down.
              </div>
            </div>
          ...
          <div className="w-full">
            <form
              className="relative z-20 flex w-full flex-col items-end "
              onSubmit={handleSubmit}
            >
              <div className="mt-3 w-full rounded-lg py-3 pt-0">
                <input
