...
function AssesmentTile({ currScore, prevScore, assessmentFeedback }) {
  ...
  return (
    <div className="mt-1 flex h-[88px] w-full flex-row items-center justify-around rounded-[10.9px] border-[1px]  border-[#3F3F3F]">
          ...
          {currScore !== prevScore && (
            <div className="flex flex-col items-center justify-center">
              {isPostiveChange ? (
                ...
                >
                  <path
                    d="M8.70718 0.0652837L1.69513 8.17854C1.48107 8.57691 1.84328 9.04061 2.2819 8.92862L5.01217 8.23162L6.49193 12.9263C7.16618 15.0646 10.1916 15.064 10.8653 12.9263L12.3456 8.23104L15.1371 8.93329C15.5752 9.04353 15.9362 8.581 15.7221 8.18263L8.70718 0.0652837Z"
                    fill="#5ECC7B"
                  />
                </svg>
              ) : (
                ...
                >
                  <path
                    d="M8.71079 15.7179L15.7228 7.60466C15.9369 7.20629 15.5747 6.74259 15.1361 6.85458L12.4058 7.55158L10.926 2.85686C10.2518 0.718598 7.22637 0.71918 6.5527 2.85686L5.07237 7.55217L2.28084 6.84991C1.84281 6.73967 1.48177 7.2022 1.69583 7.60058L8.71079 15.7179Z"
                    fill="#FA5757"
                  />
                </svg>
              )}
              <PercentChangeText style={{ color: color }}>
                {percentChange}
              </PercentChangeText>
            </div>
          )}
