...
function MarketPlace() {
    ...
    return (
        <>
            ...
            {data && !loading && !error &&
                <div className="flex min-h-screen w-screen flex-col px-4 py-4 hide-scrollbar">
                    <div className="mb-4">
                        <HiArrowNarrowLeft
                            size={20}
                            onClick={() => {
                    ...
                    <div className='w-full my-2'>
                        ...
                        <motion.div
                            className='w-full flex flex-row justify-start items-center gap-5 my-2 overflow-x-scroll hide-scrollbar'
                            variants={container}
                            initial="hidden"
                            animate="show"
                    ...
                    <div className='w-full my-2'>
                        ...
                        >
                            {
                                purchaseData && purchaseData.length !== 0 && purchaseData?.map((purchase, index) => {
                                    return (
                            ...
                            }
                            {
                                purchaseData && purchaseData.length === 0 && 
                                    <div className='w-full flex flex-row justify-center items-center my-2 text-[#545454]'>
